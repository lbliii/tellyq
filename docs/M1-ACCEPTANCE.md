...
| Fresh evidence | End-to-end replay covers partial, stale, duplicate, reordered, foreign-target, old-generation and replaced-session messages. They cannot establish fresh progress or completion; a later delayed message cannot reclaim ownership after takeover | Combined offline pass: `a0f6219` + `92bea46` |
